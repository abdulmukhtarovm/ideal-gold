            ...
            <div className="about-plintus">
                ...
                <div className="row align-items-center">
                    <div className="col-md-3 col-6">
                        <img src="./img/corner1.png" alt="" />
                    </div>
                    <div className="col-md-3 col-6">
                        <img src="./img/cornerD.png" alt="" />
                    </div>
                    ...
                    <div className="col-md-3 col-6">
                        <img src="./img/corner2.png" alt="" />
                    </div>
                    <div className="col-md-3 col-6">
                        <img src="./img/cornerD2.png" alt="" />
                    </div>
                    <div className="col-md-6 main-table">
                        <table className="table w-100 table-striped">
                            <thead>
                                ...
                                <Accordion.Body>
                                    <div className="row">
                                        <div className="col-md-4 col-6 mb-3">
                                            <img className='w-100' src="img/ug1.jpg" alt="" />
                                        </div>
                                        <div className="col-md-4 col-6 mb-3">
                                            <img className='w-100' src="img/ug2.jpg" alt="" />
                                        </div>
                                        <div className="col-md-4 col-6 mb-3">
                                            <img className='w-100' src="img/ug3.jpg" alt="" />
                                        </div>
                                    </div>
                                </Accordion.Body>
                            </Accordion.Item>
