                    ...
                    <div className="col-12">
                        <Accordion defaultActiveKey="0">
                            <Accordion.Item eventKey="0">
                                ...
                                <Accordion.Body>
                                    <img width="100%" src="./img/classic70_complect.png" alt="" />
                                </Accordion.Body>
                            </Accordion.Item>
